...
// Modified requests route to handle errors better
// Change this route
...
// Request food page route
app.get('/reqfood', (req, res) => {
    res.render('reqfood');
});

// API endpoint for handling food requests
...
// View all requests route (if you need it)
